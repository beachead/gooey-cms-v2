<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="gooeycms.webrole.betasignup.Login" %>
                    ...
                    <td class="center-column">
                       <div id="subnav">
                        ...
                        <div id="editor-area" style="padding-left: 104px">
                            <asp:Login ID="LoginControl"  runat="server" style="margin-left: 21px" Width="320px">
                                <LayoutTemplate>
