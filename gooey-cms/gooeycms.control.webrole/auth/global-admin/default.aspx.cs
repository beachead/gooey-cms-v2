...
namespace Gooeycms.Webrole.Control.auth.global_admin
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private void CheckSetupStatus()
        {
            ...
            DisplayLinkStatus(GooeyStatus.IsValueConfigured(ConfigConstants.PaypalEmail), "red", GooeyConfigManager.PaypalEmail, "Configure Paypal Email (web checkout account)", this.PaypalEmailImage, this.PaypalEmailLink, this.PaypalEmailTooltip, GooeyConfigManager.PaypalEmail, ConfigConstants.PaypalEmail, "PaypalEmail");
