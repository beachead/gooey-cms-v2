...
namespace Gooeycms.Webrole.Control.auth.global_admin.Developer
{
    public partial class Existing : System.Web.UI.Page
    {
        ...
        {
            IList<Package> packages = SitePackageManager.NewInstance.GetAllApprovedPackages();
        ...
        private void Unapprove(string guid)
        {
            SitePackageManager.NewInstance.UnapprovePackage(guid);
        }
