...
namespace Gooeycms.Data.Model.Form
{
    public class CmsSavedFormDao : BaseDao
    {
        ...
        {
            String hql = "select form from SavedForm form where form.SubscriptionId = :guid and form.Name = :name";
        ...
        {
            String hql = "select form from SavedForm form where form.SubscriptionId = :siteGuid and form.Guid = :guid";
        ...
        {
            String hql = "select forms from SavedForm forms where forms.SubscriptionId = :siteGuid";
